...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $username_err = "Napiš to česky dík";
    } else{
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    $username_err = "Toto jméno už existuje";
                } else{
    ...
    if(empty(trim($_POST["password"]))){
        ...
        $password_err = "Heslo musí být dlouhé minimálně 6 znaků";
    } else{
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#header">DOMŮ <span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
    </nav> 
    ...
    <header id="header" class="header" style="height: 100%;">
        <div class="header-content">
            ...
            <div class="form-group">
                ...
                <input type="reset" class="btn btn-secondary ml-2" value="Vymazat">
            </div>
        </form>
                </div>
            </div>
