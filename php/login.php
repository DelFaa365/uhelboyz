                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            header("location: baniky.php");
                                ...
                                $login_err = "Nejsi Admin";
                            }
                        } else{
                            // Password is not valid, display a generic error message
                            $login_err = "Neplatný heslo nebo jméno.";
                        }
                    }
                } else{
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="index.html">DOMŮ</a>
                </li>
            </ul>
        </div>
    </nav> 
    ...
    <header id="header" class="header" style="height: 100%;">
        ...
        <?php 
        if(!empty($login_err)){
            echo '<div class="alert alert-danger" style="height: 40px">' . $login_err . '</div>';
        }        
        ?>
            ...
            <a href="register.php">Vytvořit účet</a>
        </form>
                </div>
            </div>
        </div> 
